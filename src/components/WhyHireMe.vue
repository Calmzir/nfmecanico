...
.reason-item:hover {
  ...
  box-shadow: 0 15px 30px rgba(153, 24, 24, 0.15); /* Red tinted shadow on hover */
}

.icon-box {
  width: 70px;
  height: 70px;
  background: rgba(153, 24, 24, 0.08);
  border-radius: 12px; /* Soft square instead of circle for modern card look */
  display: flex;
  align-items: center;
